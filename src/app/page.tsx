...
import { Check, Menu, X, ArrowRight, Zap, Shield, BarChart, Layers } from "lucide-react"
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col">
      ...
      >
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex gap-8">
            <Link href="#features" className="text-sm font-medium text-muted-foreground hover:text-white">
              Features
            </Link>
            <Link href="#price-conversion" className="text-sm font-medium text-muted-foreground hover:text-white">
              Price Conversion
            </Link>
            <Link href="#about" className="text-sm font-medium text-muted-foreground hover:text-white">
              About
            </Link>
            <Link href="admin/upload" className="text-sm font-medium text-muted-foreground hover:text-white">
              Upload
            </Link>
          </nav>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="container py-4 flex flex-col gap-4">
              <Link href="#features" className="py-2 text-sm font-medium text-white" onClick={() => setMobileMenuOpen(false)}>
                Features
              </Link>
              <Link href="#price-conversion" className="py-2 text-sm font-medium text-white" onClick={() => setMobileMenuOpen(false)}>
                Price Conversion
              </Link>
              <Link href="#about" className="py-2 text-sm font-medium text-white" onClick={() => setMobileMenuOpen(false)}>
                About
              </Link>
              <Link href="#faq" className="py-2 text-sm font-medium text-white" onClick={() => setMobileMenuOpen(false)}>
                FAQ
              </Link>
            </div>
          </motion.div>
      ...
      <main className="flex-1">
        ...
        <section id="features" className="w-full py-20 md:py-32 bg-black">
          <div className="container px-4 md:px-6">
            ...
            >
              <Badge className="rounded-full px-4 py-1.5 text-sm font-medium bg-gray-800 text-white">
                Features
              </Badge>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white">Everything You Need to Succeed</h2>
            ...
            >
              {features.map((feature, i) => (
                <motion.div key={i} variants={item}>
                  <Card className="h-full overflow-hidden border-gray-800 bg-gradient-to-b from-gray-900 to-gray-800 backdrop-blur transition-all hover:shadow-md">
                    <CardContent className="p-6 flex flex-col h-full">
                      <div className="size-10 rounded-full bg-red-400/20 flex items-center justify-center text-red-500 mb-4">
                        {feature.icon}
                      </div>
        ...
        <CustomBackground>
          <section id="price-conversion" className="w-full py-20 md:py-32 relative overflow-hidden">
            <div className="container px-4 md:px-6 relative">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white">Real-Time Crypto Conversion</h2>
                <p className="max-w-[800px] text-white md:text-lg">
              ...
              <div className="grid gap-8 md:grid-cols-2">
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <Card className="h-full overflow-hidden border-gray-800 bg-gradient-to-b from-gray-900 to-gray-800 backdrop-blur">
                    <CardContent className="p-6">
                      <h3 className="text-xl font-bold mb-4 text-white">Currency Converter</h3>
                      <div className="space-y-4">
                        <div className="grid grid-cols-3 gap-4">
                          <div className="col-span-2">
                            <Input type="number" placeholder="Amount" className="h-12 bg-gray-900 border-gray-700 text-white" id="amount-input" />
                          </div>
                          <div>
                            <select className="w-full h-12 rounded-md border border-gray-700 bg-gray-900 px-3 py-2 text-white" id="from-currency">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          ...
                          <div>
                            <select className="w-full h-12 rounded-md border border-gray-700 bg-gray-900 px-3 py-2 text-white" id="to-currency">
                ...
                >
                  <Card className="h-full overflow-hidden border-gray-800 bg-gradient-to-b from-gray-900 to-gray-800 backdrop-blur">
                    <CardContent className="p-6">
                      <h3 className="text-xl font-bold mb-4 text-white">Your Portfolio</h3>
                      <div className="space-y-4">
                        <div className="mb-4">
                          <Input
                            type="text"
                        ...
                        <div className="border-b border-gray-800 pb-2 mb-2">
                          <h4 className="text-sm font-medium mb-1 text-gray-400">Your Portfolio Value</h4>
                          <p className="text-2xl font-bold text-white">$28,270.00</p>
                        ...
                        {[
                          ...
                          <div key={i} className="flex justify-between items-center p-3 rounded-lg bg-gray-800/50">
                            <div className="flex items-center gap-3">
                              <div className="size-8 rounded-full bg-red-400/10 flex items-center justify-center">
                                {coin.symbol.charAt(0)}
                              </div>
                              <div>
                                <p className="font-medium text-white">{coin.coin}</p>
                            ...
                            <div className="text-right">
                              <p className="font-medium text-white">{coin.value}</p>
                        ...
                        <Button className="w-full rounded-full bg-red-400 hover:bg-red-500 text-black">
                          View All Assets
                        </Button>
                      </div>
                    </CardContent>
              ...
              <motion.div
                ...
                className="mt-8"
              >
                <Card className="overflow-hidden border-gray-800 bg-gradient-to-b from-gray-900 to-gray-800 backdrop-blur">
                  <CardContent className="p-6">
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="border-b border-gray-800">
                            <th className="text-left p-3 text-gray-400">Coin</th>
                            <th className="text-right p-3 text-gray-400">Price</th>
                            <th className="text-right p-3 text-gray-400">24h Change</th>
                            <th className="text-right p-3 text-gray-400">Market Cap</th>
                            <th className="text-right p-3 text-gray-400">Volume (24h)</th>
                          </tr>
                        </thead>
                        <tbody>
                          {[
                            ...
                            <tr key={i} className="border-b border-gray-800 hover:bg-gray-800/30">
                              ...
                              <td className="text-right p-3 font-medium text-white">{coin.price}</td>
                              <td className={`text-right p-3 ${coin.change.startsWith("+") ? "text-green-500" : "text-red-500"}`}>
                                {coin.change}
                              </td>
                              <td className="text-right p-3 text-gray-400">{coin.marketCap}</td>
                              <td className="text-right p-3 text-gray-400">{coin.volume}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
        ...
        <section id="about" className="w-full py-20 md:py-32 bg-black">
          <div className="container px-4 md:px-6">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white">Our Mission</h2>
              <p className="max-w-[800px] text-gray-400 md:text-lg">
            ...
            <div className="grid gap-12 md:grid-cols-2 items-center">
              ...
              <motion.div
                ...
                className="space-y-6"
              >
                <h3 className="text-2xl font-bold text-white">Simplifying Crypto for Everyone</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-white">Secure Portfolio Tracking</h4>
                      <p className="text-sm text-gray-400">
              ...
              <div className="mx-auto max-w-3xl">
                <Accordion type="single" collapsible className="w-full">
                  {[
                    ...
                    >
                      <AccordionItem value={`item-${i}`} className="border-b border-gray-800 py-2">
        ...
        <section className="w-full py-20 md:py-32 bg-gradient-to-br from-red-900 to-red-900 text-black relative overflow-hidden">
      ...
      <footer className="w-full border-t border-gray-800 bg-black/95 backdrop-blur-sm">
        <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="#price-conversion" className="text-gray-400 hover:text-white transition-colors">
                    Price Conversion
                  </Link>
                </li>
                <li>
          ...
          <div className="flex flex-col gap-4 sm:flex-row justify-between items-center border-t border-gray-800 pt-8">
            <p className="text-xs text-gray-400">
              © {new Date().getFullYear()} ChainSwitch. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
